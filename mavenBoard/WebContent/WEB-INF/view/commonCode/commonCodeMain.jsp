...
<script type="text/javascript">
	function popDetail(code) {
		window.open('/commonCodeDetail.ino?num='+code,'','width: 800px; height: 600px;')
	}
...
<%-- 			<div style="width: 300px; float: left;"><a href="./commonCodeDetail.ino?num=${nRow.CODE }">${nRow.CODE_NAME }</a></div> --%>
			<div style="width: 300px; float: left;"><a href="#" onclick="popDetail(`${nRow.CODE}`)">${nRow.CODE_NAME }</a></div>
